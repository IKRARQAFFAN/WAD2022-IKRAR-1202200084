  ...
  <section id='form'>
    <div class="container">
      ...
      <form onsubmit="return confirm('Apakah anda yakin ingin menambah data?')" action="{{ url('save-car') }}" method="POST" enctype="multipart/form-data">
        ...
        <input type="text" id="nama" class="@error('name') is-invalid @enderror" name="name" placeholder="Masukkan Nama Mobil">
        ...
        <input type="text" id="pemilik" class="@error('owner') is-invalid @enderror" name="owner" placeholder="Masukkan Nama Pemilik">
        @error('owner')
          <div class="alert alert-danger mt-2">
              {{ $message }}
          </div>
        ...
        <input type="text" id="merk" class="@error('brand') is-invalid @enderror" name="brand" placeholder="Masukkan Merk Mobil">
        @error('brand')
            <div class="alert alert-danger mt-2">
                {{ $message }}
            </div>
        ...
        <textarea id="desc" name="description" class="@error('description') is-invalid @enderror" placeholder="Masukkan Deskripsi Mobil" style="height:200px; width: 1000px; border-radius: 8px;"></textarea>
        @error('description')
            <div class="alert alert-danger mt-2">
                {{ $message }}
            </div>
