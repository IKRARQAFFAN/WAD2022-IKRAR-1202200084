...
if (move_uploaded_file($_FILES['gambar']['tmp_name'], $target . $gambar)) {
  $sql = "INSERT showroom_Ikrar_table (nama_mobil, pemilik_mobil, merk_mobil, tanggal_beli, deskripsi, foto_mobil, status_pembayaran) VALUES ('$namamobil', '$namapemilik', '$merk', '$tanggalbeli', '$deskripsi', '$gambar', '$status')";
