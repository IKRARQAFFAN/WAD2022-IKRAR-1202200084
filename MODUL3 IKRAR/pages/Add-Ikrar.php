  ...
  <section id='form'>
    <div class="container">
      ...
      <form action="../config/insert.php" method="POST" enctype="multipart/form-data">
        ...
        <input type="text" id="nama" name="nama" placeholder="Tambahkan Nama Mobil">
        <label for="pemilik">Nama Pemilik</label>
        <input type="text" id="pemilik" name="pemilik" placeholder="Tambahkan Nama Pemilik">
        <label for="merk">Merk</label>
        <input type="text" id="merk" name="merk" placeholder="Tambahkan Merk Mobil">
        <label for="tanggalbeli">Tanggal Beli</label>
        <input type="date" id="tanggalbeli" name="tanggalbeli">
        <label for="desc">Deskripsi</label>
        <textarea id="desc" name="desc" placeholder="Tambahkan Deskripsi" style="height:200px; width: 1000px; border-radius: 8px;"></textarea>
