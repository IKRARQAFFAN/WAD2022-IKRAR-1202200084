...
if (isset($_POST["daftar"])) {
    ...
    $no_hp = $_POST["no"];
    $result = mysqli_query($connector, "SELECT email FROM user_Ikrar WHERE email = '$email'");

    if (mysqli_num_rows(($result)) !== 1 && $password == $pwdConfirm) {
        $password = password_hash($password, PASSWORD_DEFAULT);
        mysqli_query($connector, "INSERT INTO user_Ikrar VALUES ('', '$nama', '$email', '$password', '$no_hp')");
        ...
        echo "<meta http-equiv='refresh' content='2 url=Login-Ikrar.php'>";
